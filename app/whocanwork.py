...
import os
path = r"C:\Users\samue\Desktop\Program\Passchecken\data"
with open(os.path.join(path, "Anstälda.csv"), "r", encoding="utf-8") as file:
...
import os
path = r"C:\Users\samue\Desktop\Program\Passchecken\data"
with open(os.path.join(path, "week.csv"), "r", encoding="utf-8") as file:
    reader = csv.DictReader(file, skipinitialspace=True)
    for row in reader:
        day = row["day"]
        opening = row["opening"]
